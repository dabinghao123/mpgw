...
$cfg_cmspath = '';
$cfg_cookie_encode = 'SlgWM8BrDQfUaXMpwsnMh67LwpwT';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '（带手机版数据同步）高端网站建设网络设计互联网信息化服务类网站织梦模板 软件开发网络工作室网站源码下载 - AB模版网 - Www.AdminBuy.Cn';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright © 2002-2018 AB模版网 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '网站建设类模版,软件开发公司源码';
$cfg_description = '（带手机版数据同步）高端网站建设网络设计互联网信息化服务类网站织梦模板 软件开发网络工作室网站源码下载 - AB模版网 - Www.AdminBuy.Cn';
